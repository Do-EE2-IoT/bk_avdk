...
#define HEADSET_APP_MODE HEADSET_MODE_TEST_BLUETOOTH_I2S
#endif
...
int main(void)
{
    ...
    os_printf("HEADSET_MODE_DMIC_AND_I2S: DMIC to TAS5805M over I2S\r\n");
    tas5805m_demo_init();
    ...
    if (!ate_is_enabled())
    {
        ...
        {
            os_printf("DMIC_I2S: DMIC to TAS5805M over I2S started\r\n");
        }
    }
